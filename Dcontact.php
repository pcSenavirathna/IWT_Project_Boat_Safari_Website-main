...
try
{
	...
	$db = new mysqli("localhost", "root", "", "boat_safari_management_system");
...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message']))
{
	...
	$is_insert = $db->query("INSERT INTO `messages`(`Name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')");
...
<body>
    ...
    <header>
		<div class="rectangle">
			<div class="navbar">
			<div class="imglogo">
			<div class="imag"><a href="index.php"><img src="Images/DImages/Dlogo.png" height="40px" width="40px"></a></div>
