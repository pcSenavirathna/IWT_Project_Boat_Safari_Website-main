...
<body>
    <!--header-->
        ...
        <div class="back_back">
            <a href="SPaymentDetails.php"><button class="back_button">Back<button></a></div>
        <table>
            <tr>
                <th>Card Type</th>
                <th>Card Number</th>
                ...
                ?>
                            <tr>
                                ...
                                <td><ul class="editting_buttons" >
                                    <li><a class="editting" href = "SpayUpdate.php?id=<?php echo $row['payID'];?>">Edit</a></li>
                                    <li><a class="editting" href = "SpayDelete.php?id=<?php echo $row['payID'];?>">Delete</a></li>
                                </ul>
                                </td>
                            </tr>
                        <?php }
