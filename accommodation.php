<?php
	...
	if(isset($_POST['submitt'])){
		...
		$sql="insert into `accommodationbooking` (CHECKIN,CHECKOUT,ADULTS,CHILDREN,NIGHTS,rtype,No_of_rooms,fname,lname)
		values('$checkinn','$checkoutt','$adultss','$childrenn','$nightss','$rtypee','$rcountt','$fnamee','$lnamee')";
...
<html>
	...
	<!--navbar starts-->
		...
		<div class="rectangle">
			<div class="navbar">
			<div class="imglogo">
			<div class="imag"><a href="index.php"><img src="images/logo.png" height="40px" width="40px"/></a></div>
					  ...
					  <label for="ADULTS">ADULTS</label>
						...
						<br>
						  ...
						  <label for="name">NAME</label>
							...
							<button class="view"><a href="php/Kdisplay.php">View <a></button>
